...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="w-full">
        <label for="value" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            Valor da Transação <span class="text-red-500">*</span>
        </label>

        <input type="text" name="value" id="value" value="{{ old('value', $transaction->value ?? '') }}" placeholder="0.00" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white @error('value') border-red-500 @enderror">
    ...
    <div class="w-full">
        ...
        <input type="text" name="cpf" id="cpf" value="{{ old('cpf', $transaction->cpf ?? '') }}" placeholder="123.456.789-00" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white @error('cpf') border-red-500 @enderror">
    ...
    <div class="w-full">
        ...
        <select name="status" id="status" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white @error('status') border-red-500 @enderror" >
...
<div class="mt-6">
    ...
    <div class="flex items-center justify-center w-full">
        <label class="relative flex flex-col items-center justify-center w-full min-h-32 border-2 border-dashed rounded-lg cursor-pointer border-gray-300 hover:border-indigo-500 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:hover:border-indigo-400 transition overflow-hidden" for="archive"  >
            <div id="archiveEmpty" class="flex flex-col items-center justify-center pt-5 pb-6">
                <svg class="w-8 h-8 mb-3 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round"  stroke-linejoin="round" d="M7 16V8m0 0l-4 4m4-4l4 4m6 4v-8m0 0l-4 4m4-4l4 4"/>
                </svg>
            ...
            <div id="archiveSelected" class="hidden w-full p-4">
                <div class="flex items-start gap-4">
                    <img id="archivePreview" src="" alt="Preview do arquivo" class="hidden w-20 h-20 rounded-lg object-cover border border-gray-200 dark:border-gray-600 bg-white"/>
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-2">
                            ...
                            <span id="archiveTypeBadge"
                                  class="hidden inline-flex items-center px-2 py-1 text-xs font-semibold rounded-md bg-gray-100 text-gray-700"> PDF
                            </span>
                        </div>
            ...
            <input id="archive"  name="archive" type="file" accept=".pdf,.jpg,.jpeg,.png" class="hidden" />
        </label>
    </div>
